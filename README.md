...
You may be wondering, wtf is this github repo. This is a template. A template for all of you, who wants to have a decent project README.
It won't make your project amazing by default, but it will for sure make it stand out from the rest of the **default bundler readme**.

# How to use this? 

You are free to clone this file, download it, contribute to it, steal it, ignore it or do whatever you think is neccessary.
Just make sure, that you clean up all the **intro** stuff before using this template.
